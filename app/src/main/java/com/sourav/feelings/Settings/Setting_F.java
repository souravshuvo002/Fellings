package com.sourav.feelings.Settings;
...
import com.sourav.feelings.Accounts.Login_A;
import com.sourav.feelings.CodeClasses.Variables;
import com.sourav.feelings.GoogleMap.MapsActivity;
...
public class Setting_F extends Fragment {
    ...
    SwitchCompat current_location_switch,selected_location_switch;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        current_location_switch=view.findViewById(R.id.current_loction_switch);
        ...
        if(MainMenuActivity.sharedPreferences.getBoolean(Variables.is_seleted_location_selected,false)){
            ...
            current_location_switch.setChecked(true);
        }

        current_location_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        selected_location_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked){
                    MainMenuActivity.sharedPreferences.edit().putBoolean(Variables.is_seleted_location_selected,true).commit();
                    current_location_switch.setChecked(false);
                }else {
                    MainMenuActivity.sharedPreferences.edit().putBoolean(Variables.is_seleted_location_selected,false).commit();
                    current_location_switch.setChecked(true);
                }
        ...
        if(!MainMenuActivity.sharedPreferences.getString(Variables.selected_location_string,"").equals("")){
            ...
            current_location_switch.setClickable(false);
        }
       ...
       // this is the age seek bar. when we change the progress of seek bar it will be locally save
        ...
        privacy_policy_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://thefeelings.net/App/feelings/privacy_policy.html"));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 111) {
            if(resultCode == RESULT_OK) {
                ...
                current_location_switch.setClickable(true);
