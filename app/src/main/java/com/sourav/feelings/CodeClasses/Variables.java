package com.sourav.feelings.CodeClasses;
...
public class Variables {
    ...
    public static String gif_api_key1="KtlwLKtRDFFvJzBCzE5yXrhVuzYon7PC";
   ...
   public static String domain="https://thefeelings.net/App/feelings/API/index.php?p=";
