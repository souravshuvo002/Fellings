...
import com.sourav.feelings.CodeClasses.VersionChecker;
...
public class MainMenuActivity extends AppCompatActivity implements BillingProcessor.IBillingHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        token=sharedPreferences.getString(Variables.device_token,"");
        ...
        FirebaseInstanceId.getInstance()
                ...
                .addOnSuccessListener(new OnSuccessListener<InstanceIdResult>() {
                    ...
                    public void onSuccess(InstanceIdResult instanceIdResult) {
                        rootref.child("Users").child(user_id).child("token").setValue(instanceIdResult.getToken());
                        editor.putString(Variables.device_token,instanceIdResult.getToken());
                        editor.commit();
